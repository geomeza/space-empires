...
from players.experimental_player import ExperimentalPlayer
from units.experimental_unit import ExperimentalUnit

bro = ExperimentalPlayer(None, 1, [1,1], None)

print(bro.player_num)
wacky = [ExperimentalUnit]
bro.build_unit(wacky[0],[1,1], pay = False)

print(bro.units[0].unit_num)